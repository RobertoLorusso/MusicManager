...
# WARNIGN: findbygenre returns a number of songs less than
...
# WARNING:  Sometimes it is necessary to check if the songs contained in a Genre folder have the same musical genre of it.
...
class AMXML:
    def __init__(self, default=True):
        ...
        if default == False:
            ...
            self.path = "/Volumes/MSDOS/Musica/1) Genres/R&B_Soul/"
